...
class FormularioTrabajador:
    def __init__(self):
        self.trabajador1=Pruebade.Trabajador()
        self.ventana1=tk.Tk()
        self.ventana1.title("Trabajador")
    ...
    def carga_articulos(self):
        ...
        self.cuaderno1.add(self.pagina1, text="Carga de Trabajador")
        self.labelframe1=ttk.LabelFrame(self.pagina1, text="Trabajador")        
        ...
        self.label2=ttk.Label(self.labelframe1, text="Sueldo:")        
    ...
    def consulta_por_codigo(self):
        ...
        self.labelframe2=ttk.LabelFrame(self.pagina2, text="Trabajador")
        ...
        self.label3=ttk.Label(self.labelframe2, text="Sueldo:")        
    ...
    def consultar(self):
        ...
        respuesta=self.trabajador1.consulta(datos)
        if len(respuesta)>0:
    ...
    def listado_completo(self):
        ...
        self.labelframe3=ttk.LabelFrame(self.pagina3, text="Trabajador")
    ...
    def listar(self):
        respuesta=self.trabajador1.recuperar_todos()
    ...
    def borrado(self):
        ...
        self.cuaderno1.add(self.pagina4, text="Borrado de Trabajador")
        self.labelframe4=ttk.LabelFrame(self.pagina4, text="Trabajador")        
    ...
    def borrar(self):
        ...
        cantidad=self.trabajador1.baja(datos)
        if cantidad==1:
            mb.showinfo("Información", "Se borró el trabajador con dicho código")
        else:
            mb.showinfo("Información", "No existe un trabajador con dicho código")

    def modificar(self):
        self.pagina5 = ttk.Frame(self.cuaderno1)
        self.cuaderno1.add(self.pagina5, text="Modificar Trabajador")
        self.labelframe5=ttk.LabelFrame(self.pagina5, text="Trabajador")
        ...
        self.entrydescripcion.grid(column=1, row=1, padx=4, pady=4)
        self.label3=ttk.Label(self.labelframe5, text="sueldo:")        
        self.label3.grid(column=0, row=2, padx=4, pady=4)
    ...
    def modifica(self):
        ...
        cantidad=self.trabajador1.modificacion(datos)
        if cantidad==1:
            mb.showinfo("Información", "Se modificó el Trabajdor")
        else:
            mb.showinfo("Información", "No existe un Trabajdor con dicho código")
